...
1 gestor da empresa com experiência em relatórios e indicadores
...
Realização das 4 tarefas por cada participante (uma de cada vez)

Coleta dos dados conforme os critérios acima

Aplicação de questionário de satisfação ao final
